...
namespace DungeonsAndFantasyLands.API.Items.Ammo.Arrows
{
    ...
    public class ProfessionalArrow : IAmmo
    {
        ...
        public Damage AttackDamage
        {
            get
            {
                return new Damage(new Dice.Die(0, 0, 0), new Dice.Die(0, 0, 0), new Dice.Die(0, 0, 0), new Dice.Die(0, 0, 0), new Dice.Die(0, 0, 0), new Dice.Die(1, 8, 0), new Dice.Die(0, 0, 0), new Dice.Die(0, 0, 0));
            }
        }
