...
namespace MagicalLifeAPI.World.Base
{
    ...
    public class Structure
    {
        ...
        /// <summary>
        /// Holds all of the parts of this structure.
        /// </summary>
        [ProtoMember(3)]
        public List<StructurePart> Parts { get; private set; }
        ...
        /// <param name="parts">Holds all of the parts of this structure.</param>
        public Structure(string name, Guid ownerID, List<StructurePart> parts)
        {
            this.Name = name;
