...
namespace MagicalLifeAPI.World.Tiles
{
    ...
    public class ConnectedGrass : AbstractConnectedTexture
    {
        ...
        {
            return states[7] == TileState.Compatible && states[6] == TileState.Identical && states[4] == TileState.Identical;
        }
        ...
        {
            return states[3] == TileState.Identical && states[1] == TileState.Identical && states[4] == TileState.Compatible && states[6] == TileState.Compatible && states[5] != TileState.Incompatible;
        }
        ...
        {
            return states[0] == TileState.Identical && states[6] == TileState.Identical && states[3] != TileState.Incompatible && states[5] == TileState.Compatible;
        }
